  ...
  // ================================================================
  {
    ...
    testOptions: [
      { id: "bmp", name: "Basic Metabolic Panel", cost: 1, time: 30, results: [
        ...
        { name: "BUN", value: "42 mg/dL", flag: "H" },
        { name: "BUN/Cr ratio", value: "14.5 (42 / 2.9; not elevated)" },
      ], reveals: "BUN/Cr is 42 / 2.9 = 14.5, not elevated. This does not exclude prerenal AKI; interpret alongside volume losses, examination and response to treatment." },
      ...
      ], reveals: "Bland sediment with concentrated urine supports the working diagnosis; absence of casts does not exclude tubular injury or glomerular disease." },
      { id: "fena", name: "Fractional excretion of Na+ (FeNa)", cost: 2, time: 60, results: [
        { name: "FeNa", value: "0.4% (supports sodium retention; not diagnostic)", flag: "L" },
        { name: "Urine Na+", value: "12 mmol/L", flag: "L" },
        { name: "Urine osmolality", value: "540 mOsm/kg", flag: "H" },
      ], reveals: "Low FeNa and concentrated urine support sodium retention, but diuretic exposure limits FeNa interpretation. This is supportive evidence, not a diagnostic rule." },
      ...
      ], reveals: "No hydronephrosis on this scan. Reassess for obstruction if the clinical course is atypical; lack of anuria alone does not exclude it." },
      ...
      ], reveals: "Lactate alone cannot exclude shock. Hypotension with volume losses needs prompt assessment, resuscitation and reassessment; do not wait for all game tests." },
    ],
    ...
    diagnosisExplanation: "Volume losses, orthostatic hypotension and dry mucosa favour prerenal AKI from GI losses compounded by frusemide. BUN/Cr is 14.5, not >20; the ratio is not diagnostic. Concentrated urine and bland sediment support this working diagnosis but do not exclude tubular injury. FeNa is less reliable with diuretics. Absence of anuria does not exclude obstruction; assess for obstruction and obtain ultrasound when indicated. KDIGO 2012 Table 2: 2.9 / 1.1 = 2.64 times baseline means Stage 2 by creatinine, assuming the rise occurred within 7 days. Unquantified urine output cannot establish a urine-output stage.",
    stagingQuestion: {
      question: "AKI KDIGO stage by creatinine criteria (2.9 mg/dL from baseline 1.1; rise presumed within 7 days)? Urine output is not quantified.",
    ...
    managementOptions: [
      ...
      { id: "m3", step: "Dialyse urgently", correct: false, rationale: "No emergency dialysis indication is established in the initial data. Escalate for life-threatening electrolyte, acid-base or fluid derangement or uraemic complications; do not decide from creatinine or BUN alone (KDIGO 2012, 5.1.1-5.1.2)." },
      ...
      { id: "m6", step: "Recheck creatinine after fluid resuscitation", correct: true, rationale: "Reassess BP, perfusion, fluid balance, measured urine output, electrolytes and serial creatinine. Failure to improve or deterioration requires prompt reassessment for tubular injury, obstruction or other causes; do not wait 48 hours in an unstable patient." },
    ],
    harmStates: [
    ...
    teachingPoints: [
      "BUN/Cr here is 42 / 2.9 = 14.5, not elevated. A ratio >20 can support prerenal physiology but is neither required nor diagnostic; prioritise volume history, examination and reassessment.",
      "Treat hypovolaemia promptly with isotonic crystalloid and frequent reassessment for response or overload; investigate in parallel, not before resuscitation (KDIGO 2012, 3.1.1).",
      "Loop diuretics + GI losses is the classic outpatient prerenal AKI setup.",
      "Urine sediment and imaging help evaluate the cause, but individual findings are not absolute rule-in or rule-out tests. FeNa is less reliable with diuretics. KDIGO 2012 Table 2: 2.64 times baseline is Stage 2 by creatinine; quantify urine output and duration before staging by urine criteria.",
    ],
  },
